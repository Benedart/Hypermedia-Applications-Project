  ...
  <main>
        ...
        <div class="custom-row" style="min-height: 60em; padding-bottom: 10em;">
          ...
          <div class="subtitle col-md-4">
            ...
            We collaborate with visionary entrepreneurs and disruptive startups igniting breakthrough technologies and ideas, empowering the next generation of game-changers.</div>
...
.custom-btn {
    ...
    margin-left: 10.5em; /* Left margin */
