    ...
    <main>
        ...
        <div class="custom-row" style="min-height: 60em; padding-bottom: 10em;">
            ...
            <div class="subtitle col-md-4">Dedicated to fueling innovation and driving growth.
                <p>We collaborate with visionary entrepreneurs and disruptive startups igniting breakthrough technologies
                    and ideas, empowering the next generation of game-changers.</p>
            </div>
            <div class="col-md-4 mx-3 d-flex justify-content-start">
                <NuxtLink to="/about" tag="button" type="button" class="custom-btn d-flex">
                    <b>About us</b>
                </NuxtLink>
            </div>
        </div>
        ...
        <br>
        <div class="row mx-3 d-flex justify-content-center">
            <NuxtLink to="/projects" tag="button" type="button" class="btn btn-secondary d-flex justify-content-center">
        ...
        <div class="separator-margin py-5 " style="background-color: #D9D9D9;">
            ...
            <br>
            <div class="row mx-3 d-flex justify-content-center">
                <NuxtLink to="/people" tag="button" type="button" class="btn btn-secondary d-flex justify-content-center">
        ...
        <div style="background-color:#FFF">
            ...
            <div class="row image-wood" style="min-height: 60em;">
                ...
                <div class="col-md-4 mx-3 d-flex justify-content-start">
                    <NuxtLink to="/areas" tag="button" type="button" class="custom-btn-a d-flex">
                        <b>All Areas</b>
                    </NuxtLink>
                </div>
            </div>
            ...
            <div class="custom-row-c">
                <div class="content-right">
                    ...
                    <div class="col-md-4 mx-3 d-flex">
                        <NuxtLink to="/contacts" tag="button" type="button" class="custom-btn-c d-flex">
                            <b>Contact us</b>
                        </NuxtLink>
                    </div>
                </div>
...
.custom-row-c {
    ...
    margin-top: -25em;
    /* Move the row up by 25em */
    padding-bottom: 10em;
    /* Add padding at the bottom of the row */
}
...
.custom-btn {
    ...
    /* Sets how to display the button */
    padding: .375rem .75rem;
    /* Sets padding inside the button */
    vertical-align: middle;
    /* Sets vertical alignment of the button */
    user-select: none;
    ...
    /* Weight of the font */
    text-align: center;
    /* Horizontal alignment of the button text */
    align-items: start;
    /* Vertical alignment of the button content */
    color: #000022;
    ...
    transition: 0.2s;
    /* Animation effect to slowly change from one style to another */
    cursor: pointer;
