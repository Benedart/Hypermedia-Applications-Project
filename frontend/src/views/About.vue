...
<template>
    <main>
        ...
        <div class="container-fluid">
            ...
            <div class="row mx-3">
                <div class="col-md-12">
                    <h2>“Very inspirational quote here, something moving, not like what im currently writing. This is just a beautiful placeholder. I don’t know what else to write. I like cats.”</h2>
                </div>
            </div>
            <br>
            <hr>
